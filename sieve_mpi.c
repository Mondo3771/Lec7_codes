/* File:     sieve_mpi.c
 * Purpose:  Parallel computation of the number of prime numbers within integers 1 to n 
 *          
 *
 * Input:    
 * Output:   The number of prime numbers that are less than n
 *
